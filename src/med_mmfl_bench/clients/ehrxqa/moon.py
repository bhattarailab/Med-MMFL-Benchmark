"""MOON client for EHRXQA federated VQA.
...
class MoonClient(FedavgClient):
    ...
    Args:
        ...
        config: Configuration with ``train.moon_mu`` and ``train.moon_tempr``.

"""FedProx / FedNova client for SymileMIMIC multimodal retrieval.

This file is named ``fedprox.py`` but historically contained the FedNova
trainer (``SymileNovaTrainer``) and ``FednovaClient``.  The FedProx client
is provided by the separate ``fedprox`` algorithm module.
"""
